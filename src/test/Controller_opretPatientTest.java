...
public class Controller_opretPatientTest {
    ...
    public void TC1_opretPatient() {
        Patient p = controller.opretPatient("123456-7890", "Hans Hansen", 65);
    ...
    public void TC2_opretPatient() {
        Patient p = controller.opretPatient("123456-7890", "Hans Hansen", -20);
    ...
    public void TC4_opretPatient() {
        Patient p = controller.opretPatient("123456-7890", null, 65);
